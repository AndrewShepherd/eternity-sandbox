...
internal class MainWindowViewModel : ReactiveObject
{
	...
	public Placements? Placements
	{
		get
		{
			...
			{
				PartiallyExploredTreeNode seTreeNode => StackEntryExtensions.GetStackEntries(
					seTreeNode,
					[]
				).Last().StackEntry.Placements,
				_ => default
			};
		}
	}
	...
	public IReadOnlyList<StackEntry> StackEntries
	{
		get
		{
			...
			{
				PartiallyExploredTreeNode tn =>
					StackEntryExtensions.GetStackEntries(tn, [])
						.Select(e => e.StackEntry)
						.ToList(),
				_ => []
			};
		}
